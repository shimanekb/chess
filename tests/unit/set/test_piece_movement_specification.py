...
def test_is_valid_white_pawn_move_by_one_is_true():
    ...
    is_valid_move = movement_specification.is_valid(pawn, Position('a2'), Position('a3'))
...
def test_is_valid_white_pawn_move_by_one_backwards_false():
    ...
    is_valid_move = movement_specification.is_valid(pawn, Position('a3'), Position('a2'))
...
def test_is_valid_black_pawn_move_by_one_true():
    ...
    is_valid_move = movement_specification.is_valid(pawn, Position('a7'), Position('a6'))
...
def test_is_valid_black_pawn_move_by_one_backwards_false():
    ...
    is_valid_move = movement_specification.is_valid(pawn, Position('a6'), Position('a7'))
...
def test_is_valid_black_pawn_move_by_two_on_first_movement_true():
    ...
    is_valid_move = movement_specification.is_valid(pawn, Position('a7'), Position('a5'))
...
def test_is_valid_white_pawn_move_by_two_on_first_movement_true():
    ...
    is_valid_move = movement_specification.is_valid(pawn, Position('a2'), Position('a4'))
